...
for i in range(len(conditions.Conditions)):
	...
	shutil.copy2(file_name + '/000.dat', file_name2)
	shutil.copy2(file_name + '/aaa.out', file_name2)
	shutil.copy2(file_name + '_ufm/000.ufm', file_name2)
	shutil.copy2(file_name + '/PLT/locus_info.eps', file_name2)
	shutil.copy2(file_name + '/potential.cu', file_name2)
	shutil.copy2(file_name + '/sch.inp', file_name2)
